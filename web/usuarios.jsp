...
<html>
    ...
    <body>
        ...
        <div class="container">
            ...
            <a class="btn btn-primary mt-2 ml-2 mb-2" href="registrarUsuario.jsp">Agregar usuario</a>
            <table class="table table-striped">
                ...
                <tbody>
                    ...
                    %>
                    <tr>
                        <td><%= usuario2.getId()%></td>
                        <td><%= usuario2.getUsername()%></td>
                        <td><%= usuario2.getPassword()%></td>
                        <td><%= usuario2.getPerfil()%></td>
                        <td><%= usuario2.isActivo() ? "ACTIVO" : "INACTIVO"%></td>
                        <td>
                            <a class="btn btn-primary" href="editarUsuario.jsp?idUsuario=<%= usuario2.getId()%>">Editar</a>
                            <a class="btn btn-danger" href="UsuarioController?action=eliminar&idUsuario=<%= usuario2.getId()%>">Eliminar</a>
                        </td>
                    </tr>
                    <% }%>
                </tbody>
