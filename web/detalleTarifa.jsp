...
<html lang="en">
    ...
    <body data-bs-spy="scroll" data-bs-target=".navbar" data-bs-offset="100">
        ...
        <!-- Navbar section exit -->
        <%
            Tarifa tarifa = new TarifaDAO().buscarTarifa(Integer.parseInt(request.getParameter("id")));
        ...
        <section class="container">
            ...
            <div class="row">
                <div class="slide col-7">
                    <div class="slide-inner">
                        ...
                        <div class="slide-item">
                            <img src="ImagenController?nombre=<%=tarifa.getImagenes().get(0)%>">
                        </div>
                        <input class="slide-open" type="radio" id="slide-2" 
                               name="slide" aria-hidden="true" hidden="">
                        <div class="slide-item">
                            <img src="ImagenController?nombre=<%=tarifa.getImagenes().get(1)%>">
                        </div>
                        <input class="slide-open" type="radio" id="slide-3" 
                               name="slide" aria-hidden="true" hidden="">
                        <div class="slide-item">
                            <img src="ImagenController?nombre=<%=tarifa.getImagenes().get(2)%>">
                        </div>
                ...
                <div class="col-5">
                    <h4>Detalles</h4>
                    <p style="color: #828282"><%=tarifa.getDetalle()%></p>
                    <p style="color: #000"><strong>Precio: </strong>$ <%=tarifa.getPrecio()%></p>
                    <p style="color: #000"><strong>Tipo: </strong><%=tarifa.getCategoria()%></p>
                    <a class="btn btn-success" style="width: 100%" onclick="goBack()" href="#">Regresar</a>
                </div> 
