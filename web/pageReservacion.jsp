                    ...
                    fetch("ReservacionController?action=busquedaHabitacion", {
                        ...
                        body: "idHabitacion=" + idHabitacion
                            ...
                            .then(data => {
                                ...
                                document.getElementById("numeroPersonas").value = capacidad;
            ...
            <form action="ReservacionController?action=reservacionCliente" method="post">
                ...
                <div class="row">
                        ...
                        <select class="form-control" id="idHabitacion" name="idhabitacion" onchange="obtenerDatosHabitacion(this.value)" required>
                            ...
                            <% ArrayList<Habitacion> habitaciones = new HabitacionDAO().getHabitaciones(); // Obtener la lista de habitaciones desde la base de datos
                                for (Habitacion habitacion : habitaciones) {
                                    if (habitacion.isDisponible()) { // Validar si la habitación está ocupada%>
                    ...
                    <div class="form-group col-3">
                        ...
                        <input type="text" class="form-control" id="idNumero" name="idNumero" readonly>
                    </div>
                    <div class="form-group col-3">
                        <label for="ocupantes">Numero de personas:</label>
                        <input type="text" class="form-control" id="numeroPersonas" name="ocupantes" readonly>
                    </div>
                    ...
                    <div class="form-group col-6 mt-4">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control" id="precioNoche" name="precioNoche" aria-label="Amount (to the nearest dollar)" readonly>
