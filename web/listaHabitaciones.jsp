...
<html lang="en">
    ...
    <body data-bs-spy="scroll" data-bs-target=".navbar" data-bs-offset="100">
        ...
        <!-- Navbar section exit -->
        <%
            List<Habitacion> habitaciones = new HabitacionDAO().getHabitaciones();
                ...
                <div class="row m-0">
                    ...
                    <div class="col-md-4 mb-4 mb-lg-0">
                        <div class="room-item mb-4 p-2">
                            <img decoding="async" src="data:image/png;base64,<%=habitacion.getImagen()%>" width="100%" height="300px">
                            <div>
                                <h4 style="text-align: center;padding-top: 10px;color: #007bff">Habitacion N° <%=habitacion.getId()%></h4>
                                <p style="color: black"><strong>Personas: </strong><%=habitacion.getCapacidad()%></p>
                                <p style="color: black"><strong>Precio: </strong>$ <%=habitacion.getPrecioNoche()%></p>
