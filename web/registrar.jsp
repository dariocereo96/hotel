...
<html>
    ...
    <body>
        ...
        <div class="container">
            ...
            <form action="HabitacionController?action=registrar" method="POST" enctype="multipart/form-data" onsubmit="return validarFormulario();">
                <div class="form-group">
                    <label>Capacidad:</label>
                    <input type="text" name="capacidad"  required oninput="validarNumeros(this)" class="form-control" required>
                </div>
                <div class="form-group">
                    <label>Tipo:</label>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="precioNoche" step="0.01" class="form-control" oninput="validarNumerosDecimales(this)" required>
                </div>
                <div class="form-group">
